...
export const SignUp: React.FC = () => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    e.preventDefault();
    // For demo purposes, auto-login as client after sign up
    login('client');
    navigate('/');
  };
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-16 py-12 bg-white">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-stone-600 mb-8 leading-relaxed">
            Connect with reliable messengers across Harare and beyond. Send packages, run errands, and get things done with complete peace of mind.
          </p>
